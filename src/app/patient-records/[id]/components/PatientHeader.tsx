...
function InlineEdit({
  ...
  return (
    <span className="group inline-flex items-center gap-1">
      <span className={value ? '' : 'text-muted-foreground/50 italic'}>{value || placeholder}</span>
...
export function PatientHeader({
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-1 text-sm">
              ...
              <DetailRow label="Weight">
                <InlineEdit
                  ...
                  field="weight" placeholder="Add weight" {...editProps}
      ...
      {/* Profile — inline below the header, borderless */}
      <PatientProfileCard patientId={patient._id} embedded />
    </div>
  );
}
