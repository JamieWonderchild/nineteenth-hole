      ...
      template: {
        sections: [
          ...
          },
          {
            ...
            formatRuleOverride: 'Use plain markdown text only — no code blocks, no backticks, no preformatted text. Each line should be "Label: Value" format. Bold the total amount due.',
            additionalInstructionsOverride: 'Output plain readable text. Do not use triple backticks or indentation. Example format:\n**Subtotal:** $X.XX\n**Total Amount Due:** $X.XX',
          },
        ],
      },
    };
